...
N = 2^n;
K = N/2 + crc_length;
ebno_vec = 0:0.5:3; %row vec, you can write it like [1 1.5 2 2.5 3] 
...
[bler, ber] = simulationBPSK(N, K, design_epsilon, max_runs, max_err, resolution,  ebno_vec, list_vec, crc_length);
